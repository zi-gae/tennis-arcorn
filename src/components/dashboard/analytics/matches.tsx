...
import { TennisBall as TennisBallIcon } from "@phosphor-icons/react/dist/ssr/TennisBall";
...
export function Matches({ title, data }: MatchesProps): React.JSX.Element {
	const chartSize = 200;
	...
	return (
		<Card>
			<CardHeader
				...
				avatar={
					<Avatar>
						<TennisBallIcon fontSize="var(--Icon-fontSize)" />
					</Avatar>
				}
				title={title}
			/>
